...
Use Hermes to turn the AI Daily Digest and newsletters at `signals@aisignaldesk.example` into draft signal cards while keeping publication human review gated.
